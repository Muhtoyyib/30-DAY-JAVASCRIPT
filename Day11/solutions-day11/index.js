...
for (const {skills} of users){
    skills < 2 ? console.log(skills) : console.log('Candidate has more than two skills');
}
...
for (const {name: countryName, capital, languages, population} of countries_data){
   let countryData = {countryName, capital, languages, population};
...
const convertArrayToObject = (array) => {
    let students = []
    for(const [stuName, stuSkills, stuScores] of array){
        students.push({name: stuName, skills: stuSkills, scores: stuScores});
    }
