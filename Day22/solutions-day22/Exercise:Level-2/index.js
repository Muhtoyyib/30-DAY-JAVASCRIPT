...
countryCount.textContent = countries_data.length;

const container = document.getElementById("container")

let coutryDiv;
for (let i = 0; i < countries_data.length; i++){
   coutryDiv = document.createElement('div');
   coutryDiv.classList.add("col-1-of-6");

   let text = document.createElement('p');
   text.classList.add('text');
   text.textContent = countries_data[i].name;
   text.style.fontSize = '2.4rem';
   coutryDiv.appendChild(text);

   coutryDiv.style.fontSize = '2.4rem';
   coutryDiv.style.backgroundColor = '#fff';
   container.appendChild(coutryDiv);
}