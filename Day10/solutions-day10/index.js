...
// 5
let arrayOfString = ['ak', 'alade', 'akande', 'imran', 'ismaheel'];

// 6
let countriesAndChar =  []

for(let i = 0; i < countries.length; i++){
    countriesAndChar.push([countries[i], countries.length])
}

let countriesWithChar = new Map(countriesAndChar);
...
let anb = a.filter(num => B.has(num));
